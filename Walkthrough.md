...
- Checkout experience - [Customize the appearance](faq-and-common-issues/faq-serversettings#how-to-modify-the-checkout-page) of the checkout page, choose default coin, etc.
