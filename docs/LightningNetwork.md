...
See [Connecting a custodial Lightning Network wallet](./LightningNetwork-Setup/#connecting-a-custodial-lightning-network-wallet) for more information on how to set up a custodial wallet/service.
...
See [Boltz plugin](./LightningNetwork-Setup/#boltz) for more information on how to set up the plugin.
...
* does not work for shared instances
...
You can find instructions in the [Lightning Network Setup guide](./LightningNetwork-Setup/#manage-liquidity-via-a-lightning-service-provider-lsp).
...
For detailed setup instructions, see the [Lightning Network Setup guide](./LightningNetwork-Setup/#manage-liquidity-on-your-own-channel-management).
