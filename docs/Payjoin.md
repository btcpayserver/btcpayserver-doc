...
The [BTCPay Server Wallet](./Wallet.md) supports Payjoin.
...
3. Sign your transaction using either BTCPay Server's hardware wallet support via [BTCPay Server Vault](./Vault.md) or the [hot wallet](./HotWallet.md) feature.
