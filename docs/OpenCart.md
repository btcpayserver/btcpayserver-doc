...
- [You've got a BTCPay store on the instance](./Users/account-and-store-setup.md#create-a-store)
- [You've got a wallet connected to your store](./Users/wallet-setup.md)
