  ...
  describe('generates slugs equal to those on GitHub', () => {
    test.each([
      ...
      [
        ...
        'connecting-wasabi-to-btcpay-server-full-node-if-youre-self-hosting-btcpay'
      ],
      [
        `I deployed before btcpay-setup.sh existed (before May 17, 2018), can I migrate to this new system?`,
        'i-deployed-before-btcpay-setupsh-existed-before-may-17-2018-can-i-migrate-to-this-new-system'
      ],
      [
      ...
      [
        ...
        'how-to-manually-install-btcpay-on-ubuntu-1804'
      ],
      ...
      [
        ...
        '1-download-the-latest-binaries-from-a-trusted-source-such-as-httpsbitcoincoreorgendownload'
      ]
