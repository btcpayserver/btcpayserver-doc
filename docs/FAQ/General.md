...
It's possible to [create backups of your BTCPay Server](https://docs.btcpayserver.org/deployment/backuprestore/) instance and it's data. Please keep in mind that the backup scripts have not been thoroughly tested for all types of BTCPay Server setups and custom deployments.
Be sure to use your backup to verify it properly recreates your setup, before relying on it.
