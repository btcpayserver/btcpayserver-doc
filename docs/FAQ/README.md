...
General, non-technical questions about BTCPay Server. What it is, how it works, what are its features, why is it different and who can use it.
...
Questions and solutions to BTCPay Server installation.
...
* [Getting 500 nginx error on a local server https and for http (BTCPay Server is expecting you to access this website from)](./FAQ-Deployment.md#cause-4-getting-500-nginx-error-on-a-local-server-https-and-for-http-btcpay-is-expecting-you-to-access-this-website-from)
* [Error: BTCPay Server is expecting you to access this website from...](./FAQ-Deployment.md#cause-3-btcpay-is-expecting-you-to-access-this-website-from)
...
Common questions and issues that may occur during the initial sync of BTCPay Server.

* [Why does BTCPay Server sync?](./FAQ-Synchronization.md#why-does-btcpay-sync)
...
* [BTCPay Server takes forever to synchronize](./FAQ-Synchronization.md#btcpay-server-takes-forever-to-synchronize)
...
* [I already have a synced full node, can I use it with BTCPay Server?](./FAQ-Synchronization.md#im-running-a-full-node-and-have-a-synched-blockchain-can-btcpay-use-it-so-that-it-doesnt-have-to-do-a-full-sync)
...
* [How to SSH into my BTCPay Server running on VPS?](./FAQ-ServerSettings.md#how-to-ssh-into-my-btcpay-running-on-vps)
...
* [What is BTCPay Server SSH key file](./FAQ-ServerSettings.md#what-is-btcpay-ssh-key-file)
* [Forgot BTCPay Server Admin password](./FAQ-ServerSettings.md#forgot-btcpay-admin-password)
* [How to disable U2F and 2FA for a user?](./FAQ-ServerSettings.md#how-to-disable-u2f-and-2fa-for-a-user)
* [How to configure SMTP settings in BTCPay Server?](./FAQ-ServerSettings.md#how-to-configure-smtp-settings-in-btcpay)
...
* [How to customize my BTCPay Server theme style?](./FAQ-ServerSettings.md#how-to-customize-my-btcpay-theme-style)
* [How to modify BTCPay Server the checkout page?](./FAQ-ServerSettings.md#how-to-modify-the-checkout-page)
* [How to customize the POS app theme?](../Theme.md#2-bootstrap-themes)
* [How to add Google Analytics code to BTCPay Server?](./FAQ-ServerSettings.md#how-to-add-google-analytics-code-to-btcpay)
...
* [How to remotely connect to my BTCPay Server full node?](./FAQ-ServerSettings.md#how-to-remotely-connect-to-my-btcpay-full-node)

### [Files FAQ](./FAQ-ServerSettings.md#files)

* [How to upload files to BTCPay Server?](./FAQ-ServerSettings.md#how-to-upload-files-to-btcpay)
...
* [I don't see Lightning network payments in BTCPay Server wallet?](./FAQ-Wallet.md#i-dont-see-lightning-network-payments-in-btcpay-wallet)
...
* [What are the Apps in BTCPay Server?](./FAQ-Apps.md#what-are-the-apps-in-btcpay)
* [Is there a limit on the number of Apps I can create?](./FAQ-Apps.md#is-there-a-limit-on-the-number-of-apps-i-can-create)
* [Is there a Point of Sale feature in BTCPay Server?](./FAQ-Apps.md#is-there-a-point-of-sale-feature-in-btcpay)
* [How can I use BTCPay Server in a physical store?](./FAQ-Apps.md#how-can-i-use-btcpay-in-a-physical-store)
* [How to customize the appearance of POS in BTCPay Server?](./FAQ-Apps.md#how-to-customize-the-appearance-of-Point-of-Sale-App-in-BTCPay)
...
* [How to integrate WooCommerce Store in BTCPay Server Crowdfund app?](./FAQ-Apps.md#how-to-integrate-woocommerce-store-into-a-btcpay-crowdfund-app)
...
* [How to add an altcoin to BTCPay Server?](./FAQ-Altcoin.md#how-to-add-an-altcoin-in-btcpay)
