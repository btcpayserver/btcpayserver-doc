...
- Store settings - Configure individual store settings, set up derivation scheme for your wallet and adjust the number of confirmations or invoice expiration time, etc. Server admins can enable Lightning Network payments.
...
Right now dashboard only shows the basic tasks of setting up BTCPayserver, more to come in future releases.
...
Pay Button - [Create a payment button](./Apps.md#payment-button) you can easily embed into your website.
