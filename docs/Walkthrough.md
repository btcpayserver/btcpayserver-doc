...
- Store settings - Configure individual store settings, set up a derivation scheme for your wallet, adjust the number of confirmations or invoice expiration time, etc. Server admins can enable Lightning Network payments.
