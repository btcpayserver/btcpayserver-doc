...
2. Unpruned BTCPay Server node: Make sure your BTCPay Server implementation is NOT [pruned](./FAQ/FAQ-Synchronization.md#can-i-skip-the-synchronization) (i.e. you have synched and stored from genesis block. Check that you do NOT use the opt-save-storage [Environment Variable](https://github.com/btcpayserver/btcpayserver-docker/blob/master/README.md#generated-docker-compose))
...
4. Additional Fragments: You are familiar with how to use BTCPay Server's [Additional Fragment](https://github.com/btcpayserver/btcpayserver-docker/blob/master/README.md#environment-variables) feature as part of your environment variable setup.
