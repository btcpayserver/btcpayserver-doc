...
.action-button {
    color: #fff !important;
    background-image: linear-gradient(to bottom, #33a79c, #39c4b6);   /*===BUTTON BACKGROUND COLOR GRADIENT===*/
...
.action-button:hover {
    background-image: linear-gradient(to top, #33a79c, #39c4b6);  /*===HOVER BUTTON BACKGROUND COLOR GRADIENT===*/
